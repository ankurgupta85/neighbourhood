...
<%@ page
	import="java.util.*,com.neighbourhood.neighbours.*,com.neighbourhood.post.*,com.neighbours.imageUpload.*,java.io.File,com.neighbourhood.user.*"%>
	...
	<center>
		...
		<div style="overflow: hidden;">
			<form method="post" action="UpdateStatus" name="updateStatus"
				...
				<textarea rows="3" cols="70" name="post" id="post"
				...
				<%
					// Implement paging here...... 
							...
							for (int inum = 1; inum <= numPages; inum++) {
								temp = temp
										+ "<a href=\"postUpdates_temp.jsp?startIndex="
					...
					<tr>
						<td width="43%" scope="col" class="HdrParagraph">
							<%
								if (startIndex != 0) {
							%> <a
							href="postUpdates_temp.jsp?startIndex=<%=startIndex - numRecordsPerPage%>&txtnumrec=<%=numRecordsPerPage%>"
							...
							<tr>
								...
								<td width="auto"><font size="2"
									style="font-family: cursive; color: black; background-color: white; text-align: justify;"><img
										src="<%=fullPath%>" alt="<%=username%>" width="20" height="20"
